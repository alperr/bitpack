...
(function (bitpack)
{
	...
	function r4(target, o, bs)
	{
		...
		if ((vv > 2147483647) && i > 0) vv -= 2147483648; // 2147483648 -> 2^31 
		if ((vv > 1073741823) && i > 1) vv -= 1073741824; // 1073741824 -> 2^30 
		if ((vv > 536870911) && i > 2) vv -= 536870912; // 536870912 -> 2^29 
		if ((vv > 268435455) && i > 3) vv -= 268435456; // 268435456 -> 2^28 
		if ((vv > 134217727) && i > 4) vv -= 134217728; // 134217728 -> 2^27 
		if ((vv > 67108863) && i > 5) vv -= 67108864; // 67108864 -> 2^26 
		if ((vv > 33554431) && i > 6) vv -= 33554432; // 33554432 -> 2^25 
